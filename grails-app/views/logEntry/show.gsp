	...
	<body>
		...
		<div id="show-logEntry" class="content scaffold-show" role="main">
			...
			<ol class="property-list logEntry">
				...
				<g:if test="${logEntryInstance?.line}">
				<li class="fieldcontain">
					<span id="line-label" class="property-label"><g:message code="logEntry.line.label" default="Line" /></span>
					
						<span class="property-value" aria-labelledby="line-label"><g:fieldValue bean="${logEntryInstance}" field="line"/></span>
