	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
                ...
                <li><g:link class="create" action="upload"><g:message code="student.upload.label" args="[entityName]"/></g:link></li>
                <li><g:link class="list" controller="logEntry" action="index"><g:message code="default.list.label" args="['Log']"/></g:link> </li>
			</ul>
		</div>
		<div id="list-student" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="documentID" title="${message(code: 'student.documentID.label', default: 'Document ID')}" />
					
						<g:sortableColumn property="email" title="${message(code: 'student.email.label', default: 'Email')}" />
					
						<th><g:message code="student.college.label" default="College" /></th>
				...
				<g:each in="${studentInstanceList}" status="i" var="studentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: studentInstance, field: "documentID")}</td>
					
						<td>${fieldValue(bean: studentInstance, field: "email")}</td>
					
						<td>${fieldValue(bean: studentInstance, field: "college")}</td>
